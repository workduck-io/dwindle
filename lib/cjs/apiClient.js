...
var useAuth_1 = require("./useAuth/useAuth");
var client = axios_1.default.create();
var nolookalikes = '346789ABCDEFGHJKLMNPQRTUVWXYabcdefghijkmnpqrtwxyz';
var nanoid = (0, nanoid_1.customAlphabet)(nolookalikes, 21);
var generateRequestID = function () { return "REQUEST_".concat(nanoid()); };
client.interceptors.request.use(function (request) {
    var _a;
    var userCred = useAuthStore_1.default.getState().userCred;
    if (request && request.headers && userCred && userCred.token) {
        request.headers['Authorization'] = "Bearer ".concat(userCred.token);
        request.headers['wd-request-id'] = (_a = request.headers['wd-request-id']) !== null && _a !== void 0 ? _a : generateRequestID();
    }
    return request;
});
var refreshToken = function () {
    var _a = useAuthStore_1.default.getState(), userCred = _a.userCred, uPool = _a.userPool;
    if (userCred) {
        if (uPool) {
            ...
            nuser_1.getSession((0, useAuth_1.wrapErr)(function (sess) {
                if (sess) {
                    ...
                    nuser_1.refreshSession(refreshToken_1, function (err, session) {
                        if (err) {
                            ...
                            useAuthStore_1.default.setState({
                                userCred: {
